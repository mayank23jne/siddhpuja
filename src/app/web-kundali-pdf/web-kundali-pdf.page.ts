...
@Component({
  selector: 'app-web-kundali-pdf',
  templateUrl: './web-kundali-pdf.page.html',
  styleUrls: ['./web-kundali-pdf.page.scss'],
})
export class WebKundaliPdfPage implements OnInit {
  public menu_nm:any;
  public para1:any;
  public para2:any;
  public para3:any;
  ...
  ionViewDidEnter(){
    ...
    this.para1 = 'KUDALI_PDF_PARA1';
    this.para2 = 'KUDALI_PDF_PARA2';
    this.para3 = 'KUDALI_PDF_PARA3';
    this.pay_now = 'PAY_NOW';
    this.sample = 'SAMPLE_KUNDALI';
