...
import { PratahmPrashnResponsePageRoutingModule } from './pratahm-prashn-response-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    PratahmPrashnResponsePageRoutingModule,
...
export class PratahmPrashnResponsePageModule {}
