...
import { WebKundaliMatchPdfPageRoutingModule } from './web-kundali-match-pdf-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    WebKundaliMatchPdfPageRoutingModule,
...
export class WebKundaliMatchPdfPageModule {}
